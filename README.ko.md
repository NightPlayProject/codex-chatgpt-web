...
<p align="center">
  <a href="https://github.com/NightPlayProject/codex-chatgpt-web/releases/download/v6.1.1-test.11/codex-web-gpt-6.1.1-test.11-win-x64.exe"><img src="assets/readme/download-windows.svg" width="224" height="64" alt="Windows · x64"></a>&nbsp;
  <a href="https://github.com/NightPlayProject/codex-chatgpt-web/releases/download/v6.1.1-test.11/codex-web-gpt-6.1.1-test.11-mac-arm64.dmg"><img src="assets/readme/download-macos.svg" width="224" height="64" alt="macOS · Apple silicon"></a>&nbsp;
  <a href="https://github.com/NightPlayProject/codex-chatgpt-web/releases/download/v6.1.1-test.11/codex-web-gpt-6.1.1-test.11-linux-x64.AppImage"><img src="assets/readme/download-linux.svg" width="224" height="64" alt="Linux · x64"></a>
</p>

<p align="center">
  <a href="https://github.com/NightPlayProject/codex-chatgpt-web/releases/download/v6.1.1-test.11/codex-web-gpt-6.1.1-test.11-mac-x64.dmg">macOS Intel</a> · <a href="https://github.com/NightPlayProject/codex-chatgpt-web/releases/latest">모든 릴리스</a>
</p>
...
<p align="center">
  <a href="#get-started">시작하기</a> · <a href="https://github.com/NightPlayProject/codex-chatgpt-web/releases">업데이트</a> · <a href="docs/architecture.md">아키텍처</a> · <a href="TROUBLESHOOTING.md">문제 해결</a>
</p>
