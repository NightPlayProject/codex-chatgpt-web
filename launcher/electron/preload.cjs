...
contextBridge.exposeInMainWorld("codexWebLauncher", {
  ...
  setupNativeComputerUse: () => ipcRenderer.invoke("launcher:native-computer-use-setup"),
  ...
  addAccount: () => ipcRenderer.invoke("launcher:account-add"),
  addCurrentAccount: () => ipcRenderer.invoke("launcher:account-add-current"),
  startAccountLogin: (accountName) => ipcRenderer.invoke("launcher:account-login-start", accountName),
  completeAccountLogin: () => ipcRenderer.invoke("launcher:account-login-complete"),
  cancelAccountLogin: () => ipcRenderer.invoke("launcher:account-login-cancel"),
  switchAccount: (accountId) => ipcRenderer.invoke("launcher:account-switch", accountId),
  removeAccount: (accountId) => ipcRenderer.invoke("launcher:account-remove", accountId),
  ...
  onAccountsState: (listener) => subscription("launcher:accounts-state", listener),
