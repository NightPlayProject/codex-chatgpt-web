...
const en = {
  ...
  mcpBody: "Let every available ChatGPT Web effort, including Pro, use the active Codex harness and its configured MCP/plugin tools. Optional desktop control can use the same connector through a native Codex computer-use MCP.",
  ...
  nativeComputerUseTitle: "Native Windows desktop controls (optional)",
  nativeComputerUseBody: "The Windows installer includes the native open-computer-use runtime, so Node.js/npm are not required. This registers it in Codex's MCP configuration; fully restart Codex once so the tools appear.",
  installNativeComputerUse: "Set up desktop controls",
  nativeComputerUseReady: "Native Computer Use is registered",
  nativeComputerUseReadyAction: "Run setup again",
  ...
  accountSwitcherTitle: "Codex account switcher",
  accountSwitcherSubtitle: "Switch the account used by the official Codex desktop app and keep its native session separate from embedded ChatGPT.",
  accountSwitcherUnsupported: "Account switching is available when the official Windows Codex app is installed.",
  accountSwitcherNoAccounts: "No managed Codex accounts yet",
  accountSwitcherNoAccountsBody: "Add the account currently signed in to official Codex, sign in with ChatGPT, or import a compatible auth.json file.",
  accountSwitcherAddAccount: "Add account",
  accountSwitcherAddAccountBody: "Add another Codex account with the same OAuth or auth.json flow used by Codex Switcher. Credentials stay on this device.",
  accountSwitcherLogin: "Sign in with ChatGPT",
  accountSwitcherLoginBody: "Open the secure OpenAI sign-in flow in your browser.",
  accountSwitcherImportFile: "Import auth.json",
  accountSwitcherImportFileBody: "Use an auth.json exported from Codex or Codex Switcher.",
  accountSwitcherCredentialsLocal: "Only safe account metadata is shown here.",
  accountSwitcherLoginWaiting: "Waiting for browser sign-in…",
  accountSwitcherLoginWaitingBody: "Finish signing in in the browser window, then this page will add the account.",
  accountSwitcherAddCurrent: "Add current account",
  accountSwitcherRefresh: "Refresh",
  accountSwitcherRefreshing: "Refreshing…",
  accountSwitcherActive: "Active",
  accountSwitcherReady: "Ready",
  accountSwitcherExpired: "Expired",
  accountSwitcherUnavailable: "Unavailable",
  accountSwitcherAccounts: "Accounts",
  accountSwitcherAvailable: "Available",
  accountSwitcherSwitchesToday: "Switches today",
  accountSwitcherLastSwitch: "Last switch",
  accountSwitcherNever: "Never",
  accountSwitcherCurrentAccount: "Current account",
  accountSwitcherCurrentSession: "Current native session",
  accountSwitcherOfficialApp: "Official Codex app",
  accountSwitcherOfficialAppBody: "Account changes are written to the native Codex profile and the verified official app is restarted when it is running.",
  accountSwitcherRunning: "Running",
  accountSwitcherNotRunning: "Not running",
  accountSwitcherSwitchAndRestart: "Switch and restart",
  accountSwitcherApplyNextLaunch: "Apply on next launch",
  accountSwitcherSwitching: "Switching…",
  accountSwitcherActivity: "Token activity",
  accountSwitcherActivityBody: "Choose an account to view native Codex usage statistics. Local switch events remain below.",
  accountSwitcherHeatmapLess: "Less",
  accountSwitcherHeatmapMore: "More",
  accountSwitcherNoActivity: "No switch activity recorded yet.",
  accountSwitcherRecentSwitches: "Recent account activity",
  accountSwitcherNoRecentActivity: "Switch an account to start the activity history.",
  accountSwitcherManage: "Manage accounts",
  accountSwitcherShowEmails: "Show emails",
  accountSwitcherHideEmails: "Hide emails",
  accountSwitcherViewStats: "View stats",
  accountSwitcherViewingStats: "Viewing stats",
  accountSwitcherRemoveAccount: "Remove",
  accountSwitcherRemoving: "Removing…",
  accountSwitcherRemoveConfirm: "Remove this account from the switcher? The official Codex session will stay unchanged.",
  accountSwitcherManagedBy: "Compatible with Codex Switcher",
  accountSwitcherAuthChatGPT: "ChatGPT OAuth",
  accountSwitcherAuthApiKey: "API key",
  accountSwitcherImported: "Current account added",
  accountSwitcherSwitched: "Official Codex account switched",
  accountSwitcherRestarting: "Restarting official Codex",
  accountSwitcherUsageUnavailable: "Usage not refreshed",
  accountSwitcherSessionWindow: "5h window",
  accountSwitcherWeeklyWindow: "Weekly window",
  accountSwitcherLifetimeTokens: "Lifetime tokens",
  accountSwitcherToday: "Today",
  accountSwitcherLastSevenDays: "Last 7 days",
  accountSwitcherStreak: "Current streak",
  accountSwitcherLongestStreak: "Longest streak",
  accountSwitcherLongestTask: "Longest task",
  accountSwitcherTokenActivity: "Token activity",
  accountSwitcherTokenActivityBody: "Native usage statistics. Refresh to update them.",
  accountSwitcherNoTokenActivity: "Refresh usage to load Codex activity.",
  accountSwitcherResetCredits: "Reset credits",
  accountSwitcherNoResetCredits: "No reset credits available",
  accountSwitcherExpires: "expires",
  accountSwitcherCredits: "Credits",
  accountSwitcherCreditsAvailable: "Credits available",
  accountSwitcherUnlimitedCredits: "Unlimited credits",
  accountSwitcherNoCredits: "No credits",
  accountSwitcherCreditsUnavailable: "Credits unavailable",
  accountSwitcherPeakDailyTokens: "Peak daily tokens",
  accountSwitcherThreads: "Total threads",
  accountSwitcherLeft: "left",
  accountSwitcherResetsNow: "Resets now",
  accountSwitcherResetsIn: "Resets in",
  accountSwitcherResetsOn: "Resets",
  ...
  codexWallpapers: "Codex Wallpapers",
  codexWallpapersBody: "Enable the vendored Codex Wallpapers picker in the official Microsoft Store Codex/ChatGPT desktop app and reuse the local %LOCALAPPDATA%\\CodexWallpapers library. Codex Web GPT never modifies its embedded ChatGPT surface. If the official app was already open without its local wallpaper endpoint, restart the official app once after enabling.",
  codexWallpapersRestartRequired: "Restart the official Microsoft Store Codex/ChatGPT app once so Codex Wallpapers can attach. Codex Web GPT remains open.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  mcpBody: "让每一个可用的 ChatGPT Web effort（包括 Pro）访问当前 Codex Harness 及其已配置的 MCP/插件工具。可选的桌面控制可通过原生 Codex computer-use MCP 使用同一个连接器。",
  configureMcp: "配置 MCP",
  mcpReady: "MCP 已配置",
  close: "关闭",
  previous: "返回",
  ...
  nativeComputerUseTitle: "原生 Windows 桌面控制（可选）",
  nativeComputerUseBody: "Windows 安装包已包含原生 open-computer-use 运行时，因此不需要 Node.js/npm。此操作会向 Codex 注册 MCP 配置；请完全重启一次 Codex 以显示工具。",
  installNativeComputerUse: "设置桌面控制",
  nativeComputerUseReady: "原生 Computer Use 已注册",
  nativeComputerUseReadyAction: "再次运行设置",
  ...
  accountSwitcherTitle: "Codex 账户切换器",
  accountSwitcherSubtitle: "切换官方 Codex 桌面应用使用的账户，并让它与内置 ChatGPT 保持分离。",
  accountSwitcherUnsupported: "安装官方 Windows Codex 应用后即可使用账户切换。",
  accountSwitcherNoAccounts: "还没有受管理的 Codex 账户",
  accountSwitcherNoAccountsBody: "添加当前登录到官方 Codex 的账户、使用 ChatGPT 登录，或导入兼容的 auth.json 文件。",
  accountSwitcherAddAccount: "添加账户",
  accountSwitcherAddAccountBody: "使用 Codex Switcher 相同的 OAuth 或 auth.json 流程添加另一个 Codex 账户。凭据保留在此设备上。",
  accountSwitcherLogin: "使用 ChatGPT 登录",
  accountSwitcherLoginBody: "在浏览器中打开安全的 OpenAI 登录流程。",
  accountSwitcherImportFile: "导入 auth.json",
  accountSwitcherImportFileBody: "使用从 Codex 或 Codex Switcher 导出的 auth.json。",
  accountSwitcherCredentialsLocal: "此处只显示安全的账户元数据。",
  accountSwitcherLoginWaiting: "等待浏览器登录…",
  accountSwitcherLoginWaitingBody: "在浏览器窗口中完成登录，此页面会添加账户。",
  accountSwitcherAddCurrent: "添加当前账户",
  accountSwitcherRefresh: "刷新",
  accountSwitcherRefreshing: "刷新中…",
  accountSwitcherActive: "当前",
  accountSwitcherReady: "就绪",
  accountSwitcherExpired: "已过期",
  accountSwitcherUnavailable: "不可用",
  accountSwitcherAccounts: "账户",
  accountSwitcherAvailable: "可用",
  accountSwitcherSwitchesToday: "今日切换",
  accountSwitcherLastSwitch: "上次切换",
  accountSwitcherNever: "从未",
  accountSwitcherCurrentAccount: "当前账户",
  accountSwitcherCurrentSession: "当前原生会话",
  accountSwitcherOfficialApp: "官方 Codex 应用",
  accountSwitcherOfficialAppBody: "账户更改会写入原生 Codex 配置；如果已运行，经过验证的官方应用会自动重启。",
  accountSwitcherRunning: "运行中",
  accountSwitcherNotRunning: "未运行",
  accountSwitcherSwitchAndRestart: "切换并重启",
  accountSwitcherApplyNextLaunch: "下次启动时应用",
  accountSwitcherSwitching: "切换中…",
  accountSwitcherActivity: "令牌活动",
  accountSwitcherActivityBody: "选择账户以查看原生 Codex 用量统计。本地切换事件显示在下方。",
  accountSwitcherHeatmapLess: "少",
  accountSwitcherHeatmapMore: "多",
  accountSwitcherNoActivity: "还没有记录切换活动。",
  accountSwitcherRecentSwitches: "最近账户活动",
  accountSwitcherNoRecentActivity: "切换账户后会开始记录活动历史。",
  accountSwitcherManage: "管理账户",
  accountSwitcherShowEmails: "显示邮箱",
  accountSwitcherHideEmails: "隐藏邮箱",
  accountSwitcherViewStats: "查看统计",
  accountSwitcherViewingStats: "正在查看统计",
  accountSwitcherRemoveAccount: "移除",
  accountSwitcherRemoving: "移除中…",
  accountSwitcherRemoveConfirm: "从切换器中移除此账户？官方 Codex 会话不会改变。",
  accountSwitcherManagedBy: "兼容 Codex Switcher",
  accountSwitcherAuthChatGPT: "ChatGPT OAuth",
  accountSwitcherAuthApiKey: "API key",
  accountSwitcherImported: "已添加当前账户",
  accountSwitcherSwitched: "官方 Codex 账户已切换",
  accountSwitcherRestarting: "正在重启官方 Codex",
  accountSwitcherUsageUnavailable: "尚未刷新用量",
  accountSwitcherSessionWindow: "5 小时窗口",
  accountSwitcherWeeklyWindow: "每周窗口",
  accountSwitcherLifetimeTokens: "累计令牌",
  accountSwitcherToday: "今日",
  accountSwitcherLastSevenDays: "最近 7 天",
  accountSwitcherStreak: "当前连续天数",
  accountSwitcherLongestStreak: "最长连续天数",
  accountSwitcherLongestTask: "最长任务",
  accountSwitcherTokenActivity: "令牌活动",
  accountSwitcherTokenActivityBody: "原生用量统计。点击刷新以更新。",
  accountSwitcherNoTokenActivity: "刷新用量以载入 Codex 活动。",
  accountSwitcherResetCredits: "重置额度",
  accountSwitcherNoResetCredits: "没有可用的重置额度",
  accountSwitcherExpires: "到期",
  accountSwitcherCredits: "额度",
  accountSwitcherCreditsAvailable: "有可用额度",
  accountSwitcherUnlimitedCredits: "无限额度",
  accountSwitcherNoCredits: "没有额度",
  accountSwitcherCreditsUnavailable: "额度不可用",
  accountSwitcherPeakDailyTokens: "单日峰值令牌",
  accountSwitcherThreads: "线程总数",
  accountSwitcherLeft: "剩余",
  accountSwitcherResetsNow: "即将重置",
  accountSwitcherResetsIn: "重置倒计时",
  accountSwitcherResetsOn: "重置时间",
  settingsTitle: "启动器设置",
  general: "通用",
  launchAtLogin: "登录时启动",
  ...
  codexWallpapers: "Codex Wallpapers",
  codexWallpapersBody: "在官方 Microsoft Store Codex/ChatGPT 桌面应用中启用随附的 Codex Wallpapers 选择器，并复用本地 %LOCALAPPDATA%\\CodexWallpapers 库。Codex Web GPT 不会修改其内置 ChatGPT 页面。如果官方应用在没有本地壁纸端点的情况下已经打开，启用后请重启官方应用一次。",
  codexWallpapersRestartRequired: "请重启一次官方 Microsoft Store Codex/ChatGPT 应用，以便 Codex Wallpapers 连接。Codex Web GPT 会保持打开。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  mcpBody: "Pro を含む利用可能なすべての ChatGPT Web effort で、実行中の Codex ハーネスと設定済みの MCP/プラグインツールを使用できるようにします。オプションのデスクトップ操作は、ネイティブ Codex の computer-use MCP を通じて同じコネクタを使用できます。",
  ...
  nativeComputerUseTitle: "ネイティブ Windows デスクトップ操作（オプション）",
  nativeComputerUseBody: "Windows インストーラーにはネイティブ open-computer-use ランタイムが含まれるため、Node.js/npm は不要です。Codex の MCP 設定に登録するため、ツールを表示するには Codex を一度完全に再起動してください。",
  installNativeComputerUse: "デスクトップ操作を設定",
  nativeComputerUseReady: "ネイティブ Computer Use を登録しました",
  nativeComputerUseReadyAction: "設定をもう一度実行",
  ...
  accountSwitcherTitle: "Codex アカウント切り替え",
  accountSwitcherSubtitle: "公式 Codex デスクトップアプリのアカウントを切り替え、内蔵 ChatGPT から分離します。",
  accountSwitcherUnsupported: "公式 Windows Codex アプリがインストールされている場合にアカウント切り替えを利用できます。",
  accountSwitcherNoAccounts: "管理対象の Codex アカウントはまだありません",
  accountSwitcherNoAccountsBody: "公式 Codex に現在サインインしているアカウントを追加するか、ChatGPT でサインインするか、互換性のある auth.json をインポートします。",
  accountSwitcherAddAccount: "アカウントを追加",
  accountSwitcherAddAccountBody: "Codex Switcher と同じ OAuth または auth.json の流れで別の Codex アカウントを追加します。資格情報はこのデバイスに保存されます。",
  accountSwitcherLogin: "ChatGPT でサインイン",
  accountSwitcherLoginBody: "ブラウザーで安全な OpenAI サインインを開きます。",
  accountSwitcherImportFile: "auth.json をインポート",
  accountSwitcherImportFileBody: "Codex または Codex Switcher からエクスポートした auth.json を使用します。",
  accountSwitcherCredentialsLocal: "ここには安全なアカウントメタデータのみ表示されます。",
  accountSwitcherLoginWaiting: "ブラウザーのサインインを待機中…",
  accountSwitcherLoginWaitingBody: "ブラウザーでサインインを完了すると、このページにアカウントが追加されます。",
  accountSwitcherAddCurrent: "現在のアカウントを追加",
  accountSwitcherRefresh: "更新",
  accountSwitcherRefreshing: "更新中…",
  accountSwitcherActive: "アクティブ",
  accountSwitcherReady: "準備完了",
  accountSwitcherExpired: "期限切れ",
  accountSwitcherUnavailable: "利用不可",
  accountSwitcherAccounts: "アカウント",
  accountSwitcherAvailable: "利用可能",
  accountSwitcherSwitchesToday: "今日の切り替え",
  accountSwitcherLastSwitch: "最後の切り替え",
  accountSwitcherNever: "なし",
  accountSwitcherCurrentAccount: "現在のアカウント",
  accountSwitcherCurrentSession: "現在のネイティブセッション",
  accountSwitcherOfficialApp: "公式 Codex アプリ",
  accountSwitcherOfficialAppBody: "アカウントの変更はネイティブ Codex プロファイルに保存され、起動中の公式アプリは再起動されます。",
  accountSwitcherRunning: "実行中",
  accountSwitcherNotRunning: "未実行",
  accountSwitcherSwitchAndRestart: "切り替えて再起動",
  accountSwitcherApplyNextLaunch: "次回起動時に適用",
  accountSwitcherSwitching: "切り替え中…",
  accountSwitcherActivity: "トークンアクティビティ",
  accountSwitcherActivityBody: "アカウントを選択すると、ネイティブ Codex の使用量統計を表示します。ローカルな切り替えイベントは下に表示されます。",
  accountSwitcherHeatmapLess: "少ない",
  accountSwitcherHeatmapMore: "多い",
  accountSwitcherNoActivity: "切り替えアクティビティはまだありません。",
  accountSwitcherRecentSwitches: "最近のアカウントアクティビティ",
  accountSwitcherNoRecentActivity: "アカウントを切り替えると履歴の記録が始まります。",
  accountSwitcherManage: "アカウントを管理",
  accountSwitcherShowEmails: "メールを表示",
  accountSwitcherHideEmails: "メールを非表示",
  accountSwitcherViewStats: "統計を表示",
  accountSwitcherViewingStats: "統計を表示中",
  accountSwitcherRemoveAccount: "削除",
  accountSwitcherRemoving: "削除中…",
  accountSwitcherRemoveConfirm: "このアカウントをスイッチャーから削除しますか？公式 Codex セッションは変更されません。",
  accountSwitcherManagedBy: "Codex Switcher と互換",
  accountSwitcherAuthChatGPT: "ChatGPT OAuth",
  accountSwitcherAuthApiKey: "API キー",
  accountSwitcherImported: "現在のアカウントを追加しました",
  accountSwitcherSwitched: "公式 Codex アカウントを切り替えました",
  accountSwitcherRestarting: "公式 Codex を再起動中",
  accountSwitcherUsageUnavailable: "使用量は未更新",
  accountSwitcherSessionWindow: "5 時間ウィンドウ",
  accountSwitcherWeeklyWindow: "週間ウィンドウ",
  accountSwitcherLifetimeTokens: "累計トークン",
  accountSwitcherToday: "今日",
  accountSwitcherLastSevenDays: "過去 7 日間",
  accountSwitcherStreak: "現在の連続日数",
  accountSwitcherLongestStreak: "最長連続日数",
  accountSwitcherLongestTask: "最長タスク",
  accountSwitcherTokenActivity: "トークンアクティビティ",
  accountSwitcherTokenActivityBody: "ネイティブの使用量統計です。更新して最新情報を取得します。",
  accountSwitcherNoTokenActivity: "使用量を更新すると Codex アクティビティが表示されます。",
  accountSwitcherResetCredits: "リセットクレジット",
  accountSwitcherNoResetCredits: "利用可能なリセットクレジットなし",
  accountSwitcherExpires: "期限",
  accountSwitcherCredits: "クレジット",
  accountSwitcherCreditsAvailable: "クレジットあり",
  accountSwitcherUnlimitedCredits: "無制限クレジット",
  accountSwitcherNoCredits: "クレジットなし",
  accountSwitcherCreditsUnavailable: "クレジット情報なし",
  accountSwitcherPeakDailyTokens: "1 日の最大トークン",
  accountSwitcherThreads: "総スレッド数",
  accountSwitcherLeft: "残り",
  accountSwitcherResetsNow: "まもなくリセット",
  accountSwitcherResetsIn: "リセットまで",
  accountSwitcherResetsOn: "リセット",
  ...
  codexWallpapers: "Codex Wallpapers",
  codexWallpapersBody: "公式 Microsoft Store Codex/ChatGPT デスクトップアプリで Codex Wallpapers ピッカーを有効にし、ローカルの %LOCALAPPDATA%\\CodexWallpapers ライブラリを再利用します。Codex Web GPT は内蔵 ChatGPT 画面を変更しません。公式アプリがローカル壁紙エンドポイントなしですでに開いている場合は、有効化後に公式アプリを一度再起動してください。",
  codexWallpapersRestartRequired: "Codex Wallpapers を接続するため、公式 Microsoft Store Codex/ChatGPT アプリを一度再起動してください。Codex Web GPT は開いたままです。",
